...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('ajaxlogin', MODX_CORE_PATH . 'components/ajaxlogin/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/ajaxlogin/model/schema/ajaxlogin.mysql.schema.xml';
