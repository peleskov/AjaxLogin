...
class AjaxLoginOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('ajaxlogin_item_err_ns');
        }
...
return 'AjaxLoginOfficeItemUpdateProcessor';
